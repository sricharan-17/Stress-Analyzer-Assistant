...
Due to GitHub file size limits, trained model files are not included in this repository.

- `rf_stress_model_balanced.pkl`
- `label_encoders.pkl`

These files can be:
- Regenerated by retraining the model using the provided training pipeline, or
- Shared separately upon request.
